        ...
        >
            ...
            <div className="w-full flex justify-start items-center mt-[1rem] gap-[60px]">
                <a href="https://github.com/notyaaz">
                    <i className="cursor-pointer text-[1.75rem] fa-brands fa-github hover:text-gray-800"></i>
                </a>
                <a href="https://www.linkedin.com/in/yazan-dalbah-341852247">
                    <i className="cursor-pointer text-[1.75rem] fa-brands fa-linkedin-in hover:text-cyan-800"></i>
                </a>
                <a href="https://www.facebook.com/profile.php?id=100059650716541">
                    <i className="cursor-pointer text-[1.75rem] fa-brands fa-facebook hover:text-blue-700"></i>
                </a>
                <i className="cursor-pointer text-[1.75rem] fa-solid fa-envelope hover:text-amber-700"></i>
            </div>
        </div>
    );
}
